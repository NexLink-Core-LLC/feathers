...
// DirectorySize calculates the size of a directory and its descendants. The
// implementation is platform-specific (hard-link deduplication via inode on
// Unix; a plain size sum on Windows) and lives in disk_space_unix.go and
