...
// errnoToPathError converts an errno into a proper path error. The mapping is
// platform-specific (Unix errno values vs Windows error codes) and is defined
// in errors_unix.go and errors_windows.go.
